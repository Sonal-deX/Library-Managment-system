...
import PaperUpdateModal from './PaperUpdateModal'
import PaperDeleteModal from './PaperDeleteModal'
// material
  ...
  return (
    <>
      ...
      >
        ...
        <PaperDeleteModal onClose={closeHandler} paper={props.selectedPaper} reload={props.paperReload} />
        <PaperUpdateModal onClose={closeHandler} paper={props.selectedPaper} reload={props.paperReload} />
